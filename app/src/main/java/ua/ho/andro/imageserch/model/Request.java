...
public class Request {
     ...
     */
    public Request(String title, String totalResults, String searchTerms, int count, int startIndex, String inputEncoding, String outputEncoding, String safe, String cx, String searchType) {
        this.title = title;
    ...
    public Request withCount(int count) {
        this.count = count;
        return this;
    }
    ...
    public Request withStartIndex(int startIndex) {
        this.startIndex = startIndex;
        return this;
    }
    ...
    public Request withSearchType(String searchType) {
        this.searchType = searchType;
        return this;
    }
